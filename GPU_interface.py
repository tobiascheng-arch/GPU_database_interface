...
#added ALL_FIELDS to make it look clewaner
...
#While loop that loops until "x" or cancel is pressed, loops through asking t
while True:
    ...
    if choice == "Queries":
        ...
        msg ="Type down the year you want to see, (make sure it is between 2016 and2025):"
        title = "GPU database"
